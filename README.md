...
```text
<Insira aqui o primeiro prompt utilizado.>
```
...
```text
<Insira aqui a segunda versão do prompt.>
```
...
Durante a utilização do NotebookLM alguns desafios apareceram.

| Problema | Solução |
|----------|----------|
| Respostas muito genéricas | Tornar o prompt mais específico |
| Informações incompletas | Fazer perguntas segmentadas |
| Resumos superficiais | Solicitar exemplos práticos |
| Conceitos confusos | Pedir analogias e comparações |
| Muito texto | Solicitar tabelas e listas |
...
Escreva aqui um resumo estruturado contendo os principais tópicos aprendidos durante o estudo.
